	...
	\resumeSubHeadingListStart
		\resumeSubheading
			...
			{\scriptsize { \footnotesize{\newline{}\textbf{Courses:}
                \hspace{}Machine Learning, Artificial Intelligence, Computer Architecture, Data Visualization
			}}}
...
\section{Experience}
	\resumeSubHeadingListStart
      \resumeSubheading
            ...
            {Aug 2022 -- Present}
            \resumeItemListStart
			\resumeItem{Developed a computer vision project using OpenCV's HOG detector for whole-body detection.}
            \resumeItem{Implemented detection of humans and their distance from the camera..}
...
\section{Skills Summary}
	\resumeSubHeadingListStart
		...
		\resumeSubItem{Tools/Packages}
            {\hspace{0.3mm}sklearn, Streamlit, Matplotlib, NumPy, BeautifulSoup, Pandas, OpenCV, Figma }
	\resumeSubHeadingListEnd
